    ...
    <div class="back-top-wrapper">
        ...
        <div class="fixed-top menu-fixed">
            <div class="menu-fixed-wrapper">
                ...
                <center>
                    <p class="text-profil-pengguna-edit">Data Customer</p>
                </center>
            </div>
        </div>
                            ...
                            <div class="d-flex align-items-center">
                                <div class="d-flex flex-1 img-detail cur-pointer ">
                                    <div class="mutasi-text">
                                        <div class="text-14">{{ $p->name }}</div>
                                        <div>{{ $p->email }} </div>
                                    </div>
                                </div>
                                <div class="ellipsis-right cur-pointer">
                                    <a href="customer/{{$p->id}}/edit"><img src="asset/img/icon-edit.svg" class="edit-detail-bank"></a>
                                    <a href="customer/{{$p->id}}/delete"><img src="asset/img/icon-delete.svg" class="edit-detail-bank"></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
...
<script>
    $("#tambah-produk").click(function () {
        setTimeout(function () {
            window.location.href = '{{ url('customer/tambahcustomer')}}';
        }, 300)
    })
</script>
</html>