                ...
                <div class="col-12">
                    <div class="fixed-top menu-fixed fixed-judul">
                        <div class="menu-fixed-wrapper">
                            ...
                            <center>
                                <p class="text-profil-pengguna-edit">Tambah Data Customer</p>
                            </center>
                        </div>
                    </div>
                </div>
                 <form action="{{url('/customer/simpancustomer')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                id="name" required="required" placeholder="Masukkan Nama Barang">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                id="phone" required="required" placeholder="Masukkan No HP">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
